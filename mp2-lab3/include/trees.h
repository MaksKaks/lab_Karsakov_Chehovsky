...
//         Node() : parent(nullptr), length(0), isLeaf(false) {
//             sons[0] = sons[1] = sons[2] = nullptr;
//         }

//         Node(const TKey& k, const TValue& v)
//             : parent(nullptr), length(0), isLeaf(true) {
//             sons[0] = sons[1] = sons[2] = nullptr;
//             data = Pair(k, v);
//             keys[0] = k;
//         }
...
//         while (node && !node->isLeaf) {
//             if (node->length == 2) {
//                 node = (node->keys[0] < key) ? node->sons[1] : node->sons[0];
//             } else {
//                 if (node->keys[1] < key) node = node->sons[2];
//                 else if (node->keys[0] < key) node = node->sons[1];
//                 else node = node->sons[0];
//             }
//         }
//         return node;
//     }
...
//         rightPart->sons[0] = parent->sons[2];
//         rightPart->sons[1] = parent->sons[3];
//         rightPart->sons[0]->parent = rightPart;
//         rightPart->sons[1]->parent = rightPart;
...
//         if (bratparent->length == 3) {
//             Node* borrowed = bratIsLeft
//                 ? bratparent->sons[bratparent->length - 1]
//                 : bratparent->sons[0];
//             if (bratIsLeft) {
//                 bratparent->length--;
//             } else {
//                 bratparent->sons[0] = bratparent->sons[1];
//                 bratparent->sons[1] = bratparent->sons[2];
//                 bratparent->sons[2] = nullptr;
//                 bratparent->length--;
//             }
...
//                 newRoot->sons[1] = pos;
//             }
//             pos->parent = leaf->parent = newRoot;
//             root = newRoot;
//             sortsons(newRoot);
//             updatekeys(newRoot);
//             return;
